...
#[derive(new)]
pub struct UpdaqteBookRequestWithIds(BookId, UserId, UpdateBookRequest);

impl From<UpdaqteBookRequestWithIds> for UpdateBook {
    fn from(value: UpdaqteBookRequestWithIds) -> Self {
        let UpdaqteBookRequestWithIds(
            book_id,
            user_id,
            UpdateBookRequest {
                title,
